...
extension String {
    ...
    var hankaku: String {
        ...
        convertFullWidthToHalfWidth(reverse: false)
        
    }
    
    var zenkaku: String {
        
        convertFullWidthToHalfWidth(reverse: true)
        
    }
    
    var hankakuOnlyNumber: String {
        
        convertFullWidthToHalfWidthOnlyNumber(fullWidth: false)
        
    }
    
    var zenkakuOnlyNumber: String {
        
        convertFullWidthToHalfWidthOnlyNumber(fullWidth: true)
